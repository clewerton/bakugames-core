...
public class SlickBasicGame extends BasicGameState {
  ...
  public void init(GameContainer gc, StateBasedGame sbg) throws SlickException {
    ...
    plane.plug(new Body(new Image("src/test/example/simpletestgame/trollface.png"), 400, 300, 0));
    
    land = new Entity(world, 0);
    land.plug(new BackgroundRenderer(new Image("src/test/example/simpletestgame/land.jpg")));
